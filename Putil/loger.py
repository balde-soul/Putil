...
import Putil.base.logger as logger

LogReflect = logger.LogReflect
PutilLogConfig = logger.PutilLogConfig
...
HTTPHandler = logger.HTTPHandler
SMTPHandler = logger.SMTPHandler
...
# file param
file_param = logger.file_param
rotating_file_param = logger.rotating_file_param
...
# method
no_log_handler = logger.no_log_handler
file_method = logger.file_method
rotating_file_method = logger.rotating_file_method
stream_method = logger.stream_method
