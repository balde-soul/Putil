...
def Giou_np(bbox_p, bbox_g):
    """
     ...
     @note
     @param[in] bbox_p
     predict of bbox (N, 4) (top_left_x, top_left_y, width, height)
     @param[in] bbox_g 
     groundtruth of bbox (N, 4) (top_left_x, top_left_y, width, height)
     @ret
    """
    # for details should go to https://arxiv.org/pdf/1902.09630.pdf
    # ensure predict's bbox form
    bbox_p[:, 2: 4] = bbox_p[:, 0: 2] + bbox_p[:, 2: 4]
    bbox_g[:, 2: 4] = bbox_g[:, 0: 2] + bbox_g[:, 2: 4]
