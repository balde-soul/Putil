...
import Putil.trainer.train_common as train

TrainCommon = train.TrainCommon
root_logger = train.root_logger
TrainCommonLog = train.TrainCommonLog
cv_test = train.cv_est
# # coding=utf-8
